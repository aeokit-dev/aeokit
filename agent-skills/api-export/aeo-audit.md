...
3. Read the project, crawler-traffic history, citations, opportunities, and existing experiments relevant to the audited question. Preserve returned IDs, timestamps, provider/surface labels, URLs, and evidence status.
